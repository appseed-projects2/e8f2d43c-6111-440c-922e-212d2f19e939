...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-07 12:06`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e8f2d43c-6111-440c-922e-212d2f19e939.git
$ cd e8f2d43c-6111-440c-922e-212d2f19e939
```
